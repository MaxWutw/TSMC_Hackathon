...
14. If you get the base64 data, you can return immediately, instead of turn it into PIL.IMAGE.
15. You should execute python code with packages that are already installed in the environment.
16. If your execution result in python has an error, you should manage to fix the error the run the code again.
17. Make sure that the answer is ideal and you can try to calculate the answer multiple times to make sure the final answer is right.
18. If you want to get the answer relative to contour, maybe you can try out opencv or cv2.
