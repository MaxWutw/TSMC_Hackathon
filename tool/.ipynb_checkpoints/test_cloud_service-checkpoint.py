...
image = PIL.Image.open("../data/public_set/c1ada5be-4ab9-43c1-8742-8e1e384f7df1/ref.png")
...
if response.status_code == 200:
    ...
    for object in objects:
        ...
        ratio = fuzz.ratio(object['name'], 'bear')
        print(ratio)
        
        ratio = fuzz.partial_ratio(object['name'], 'bear')
        print(ratio)
        
        ratio = fuzz.token_sort_ratio(object['name'], 'bear')
        print(ratio)
